...
export default function Challenges(props) {
  ...
  const navigateChallenge = (id) => {
    navigate(`/HackathonDetails/${id}`);
  };
          ...
          props.searchedData.map((hackathon) => {
            return (
              <div className="hackathon_card">
                ...
                <div className="card_image"><img src={hackathon.img} alt="" /></div>
                <div className="timeline">
                  <p className={"when active " + ((hacks_time !== 0) && "none")}>
                    Active
                  </p>
                  <p className={"when upcoming " + ((hacks_time !== 1) && "none")}>
                    Upcoming
                  </p>
                  <p className={"when past " + ((hacks_time !== -1) && "none")}>
                    Past
                  </p>
                  <p></p>
                </div>
                ...
                <button className="participate_btn" onClick={()=>navigateChallenge(hackathon.id)}>
                  <span style = {{marginRight: "2px"}}><TaskAltOutlinedIcon/>  </span>Participate Now
                </button>
              </div>
            );
          })
